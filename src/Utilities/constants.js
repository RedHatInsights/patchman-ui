...
export const ENABLE_PACKAGES =
    window?.insights?.chrome?.isBeta && insights?.chrome?.isBeta();
...
export const patchSetUnassignSystemsNotifications = (systemsCount) => ({
    success: {
        ...
        description: `${systemsCount} ${
            systemsCount > 1 ? "systems" : "system"
        } removed from Patch template(s)`,
        variant: "success",
    },
});

export const TEMPLATES_DOCS_LINK =
    "https://access.redhat.com/documentation/en-us/red_hat_insights/2023/html/" +
