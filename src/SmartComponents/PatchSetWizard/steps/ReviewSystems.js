...
export const ReviewSystems = ({ systemsIDs = [], patchSetID, ...props }) => {
  ...
  return (
    <Stack hasGutter>
      <StackItem>
        <Content>
          <Content component='h2'>{intl.formatMessage(messages.templateApplySystems)}</Content>
        </Content>
      </StackItem>
      <StackItem>
        <Content>
          <Content component={ContentVariants.p}>
            Select systems to apply the new template to. The list of systems <b>does not contain</b>{' '}
