...
const renderTextListItem = (label, text) => (
  <Fragment>
    ...
    <Content component={ContentVariants.dd}>{text}</Content>
  </Fragment>
);
...
const ReviewPatchSet = () => {
  ...
  return (
    <Stack hasGutter>
      <StackItem>
        <Content>
          <Content component='h2'>{intl.formatMessage(messages.templateReview)}</Content>
        </Content>
      </StackItem>
      <StackItem>
      ...
      <StackItem>
        <Content>
          <Content component='h2' className='pf-v6-u-mt-md pf-v6-u-mb-sm'>
